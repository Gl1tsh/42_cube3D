...
/*   Updated: 2024/03/29 15:56:46 by nagiorgi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	find_player(t_game *game)
{
	...
	{
		if (game->map.bytes[i] == 'N' || game->map.bytes[i] == 'S' || game->map.bytes[i] == 'E' || game->map.bytes[i] == 'W')
		{
			...
			game->player_angle = (ft_strchr(cardinal_point, game->map.bytes[i]) - cardinal_point) * M_PI_2;
			game->map.bytes[i] = '0';
			return (0);
		}
		i++;
